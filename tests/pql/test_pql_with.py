...
def test_simply_with_left_query():
    ...
    assert result[0]["conditions"]["attributes"][0]["left"] == "w3"
...
def test_simply_with_query():
    ...
    assert len(result[0]["conditions"]["attributes"]) == 1
    assert result[0]["conditions"]["attributes"][0]["right"] == "w3"
    assert result[0]["conditions"]["attributes"][0]["attr_right"] == "varName"
...
def test_multiply_with_query():
    ...
    assert result[0]["conditions"]["attributes"][1]["left"] == "s2"
